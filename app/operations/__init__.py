...
def division(a: float, b: float) -> float:
    ...
    But if we call division(10.0, 0.0), it will raise a ValueError and say "Cannot divide by zero."
    """
    if b == 0:
        # This part checks if 'b' is zero. If it is, we raise an error and stop the function.
        raise ValueError("Cannot divide by zero.")  # This sends an error message when someone tries to divide by zero.
